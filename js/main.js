...
Var x is a local variable, however, var y is not a global variable.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) would print undefined. It hoists the variable to the top but not the value assigned to it.
Console.log(y) doesn't exist in this function, therefor nothing would happen. If you are referring to console.log(foo()) would return "function hoisting".
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
Inside of the IFEE it will print 4. Outside of the IFEE it will not print anything.
**************************************************************************************/
...
(function(){
  var birthday = new Date(1983, 3, 21).getTime();
